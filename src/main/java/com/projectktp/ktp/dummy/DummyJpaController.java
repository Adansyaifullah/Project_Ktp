...
import com.projectktp.ktp.dummy.Dummy;
import com.projectktp.ktp.exceptions.NonexistentEntityException;
import com.projectktp.ktp.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.projectktp_ktp_jar_0.0.1-SNAPSHOTPU");
